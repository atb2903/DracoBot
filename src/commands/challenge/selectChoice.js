 ...
 * @description Handles the selection of a choice in the rock-paper-scissors game, calculates the result, and updates the message accordingly.
 * @param {Object} req - The request object containing interaction data.
